...
class ParameterBag implements \IteratorAggregate, \Countable
{
    ...
    public function initialize(string $sourceDir, string $htmlOutputDir, string $jsonOutputDir, ?string $parseOnly)
    {
        ...
        $this->set('jsonOutputDir', $jsonOutputDir);
    ...
    {
        if (!$this->initialized) {
            throw new \RuntimeException('Parameter bag should be initialized before getting parameters.');
        }
